...
#SBATCH --job-name=small_families_50_to_99_chosen_except_for_tested_const
...
#SBATCH --output=/groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/small_families_50_to_99/chosen_except_for_tested/main_job-chosen_except_for_tested-const/out.OU
#SBATCH --error=/groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/small_families_50_to_99/chosen_except_for_tested/main_job-chosen_except_for_tested-const/err.ER
...
cd /groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/small_families_50_to_99/chosen_except_for_tested/main_job-chosen_except_for_tested-const
python /groups/itay_mayrose/noybandel/ChromEvol_project/scripts/create_pfiles_and_run_jobs_for_chosen.py \
    ...
    > /groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/small_families_50_to_99/chosen_except_for_tested/main_job-chosen_except_for_tested-const/log.txt \
    2> /groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/small_families_50_to_99/chosen_except_for_tested/main_job-chosen_except_for_tested-const/err.txt
