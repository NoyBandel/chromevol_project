...
#SBATCH --job-name=1_fam_chosen_const
...
#SBATCH --output=/groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/1_family_for_test/chosen_except_for_tested/main_job-1_family_for_test-const/output.OU
#SBATCH --error=/groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/1_family_for_test/chosen_except_for_tested/main_job-1_family_for_test-const/err.ER
...
cd /groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/1_family_for_test/chosen_except_for_tested/main_job-1_family_for_test-const/
...
python /groups/itay_mayrose/noybandel/ChromEvol_project/scripts/create_pfiles_and_run_jobs_for_chosen.py \
    ...
    > /groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/1_family_for_test/chosen_except_for_tested/main_job-1_family_for_test-const/log.txt \
    2> /groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/1_family_for_test/chosen_except_for_tested/main_job-1_family_for_test-const/err.txt
