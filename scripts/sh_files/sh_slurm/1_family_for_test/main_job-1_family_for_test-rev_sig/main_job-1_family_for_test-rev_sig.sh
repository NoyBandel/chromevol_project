...
#SBATCH --output=/groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/1_family_for_test/main_job-1_family_for_test-rev_sig/output.OU
#SBATCH --error=/groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/1_family_for_test/main_job-1_family_for_test-rev_sig/err.ER
...
cd /groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/1_family_for_test/main_job-1_family_for_test-rev_sig/
