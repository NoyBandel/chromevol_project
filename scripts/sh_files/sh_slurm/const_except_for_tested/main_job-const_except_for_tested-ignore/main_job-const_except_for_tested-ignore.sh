...
#SBATCH --job-name=all_fam_ignore
...
#SBATCH --output=/groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/const_except_for_tested/main_job-const_except_for_tested-ignore/output.OU
#SBATCH --error=/groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/const_except_for_tested/main_job-const_except_for_tested-ignore/err.ER
...
cd /groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/const_except_for_tested/main_job-const_except_for_tested-ignore/
