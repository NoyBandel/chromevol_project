...
#SBATCH --output=/groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/const_except_for_tested/main_job-const_except_for_tested-exponential/output.OU
#SBATCH --error=/groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/const_except_for_tested/main_job-const_except_for_tested-exponential/err.ER
...
cd /groups/itay_mayrose/noybandel/ChromEvol_project/scripts/sh_files/sh_slurm/const_except_for_tested/main_job-const_except_for_tested-exponential/
